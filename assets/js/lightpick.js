...
(function(root, factory) {
    ...
    var document = window.document,
        ...
        weekdayName = function(opts, day, short) {
            return new Date(1970, 0, day).toLocaleString(
                opts.lang,
                {
        ...
        renderMonthsList = function(date, opts) {
            ...
            for (var idx = 0; idx < 12; idx++) {
                ...
                option.text = d.toDate().toLocaleString(
                    opts.lang,
                    {
                        month: "long"
                    }
    ...
    Lightpick.prototype = {
        ...
        updatePosition: function() {
            if (this.el.classList.contains("lightpick--inlined")) return; // remove `is-hidden` class for getBoundingClientRect
